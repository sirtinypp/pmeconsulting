...
urlpatterns = [
    ...
    path('management/activities/review/', dashboard_views.activity_review_list, name='activity_review_list'),
    path('management/activity/submission/<int:pk>/review/', dashboard_views.activity_review_detail, name='activity_review_detail'),
